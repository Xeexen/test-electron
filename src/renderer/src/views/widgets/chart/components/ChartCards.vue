...
<template>
  <v-row class="mb-0">
    <VCol cols="12">
      <h1 class="tw:text-xl tw:font-semibold">Tareas del ultimo mes</h1>
    </VCol>
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-subtitle-1 mb-0">Pendientes</h6>
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5 class="text-h5">{{ props.dashboard?.totalTask }}</h5>
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-subtitle-1 mb-0">En proceso</h6>
              <template v-slot:append>
                <!-- <v-menu width="150" location="start">
                  <template v-slot:activator="{ props }">
                    <v-btn
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5 class="text-h5">{{ props.dashboard?.inProgressTask }}</h5>
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-subtitle-1 mb-0">Completadas</h6>
              <template v-slot:append>
                <!-- <v-menu width="150" location="start">
                  <template v-slot:activator="{ props }">
                    <v-btn
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5 class="text-h5">{{ props.dashboard?.completedTask }}</h5>
        ...
        <v-card-text>
          <v-list class="pt-0" aria-busy="true" aria-label="chart content">
            <v-list-item class="pa-0">
              ...
              <h6 class="text-subtitle-1 mb-0">Atrasadas</h6>
              <template v-slot:append>
                <!-- <v-menu width="150" location="start">
                  <template v-slot:activator="{ props }">
                    <v-btn
          ...
          <v-sheet class="pa-6 pb-3 mt-1" color="containerBg" rounded="lg">
            <v-row class="widget-grid">
              ...
              <v-col cols="5">
                <h5 class="text-h5">{{ props.dashboard?.overdueTask }}</h5>
                <p class="text-body-1 text-error mb-0">
                  <SvgSprite
                    name="custom-fall-outline"
                    style="width: 16px; height: 16px; transform: rotate(130deg)"
                  />
                  30.6%
                </p>
              </v-col>
